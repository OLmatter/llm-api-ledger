...
VENDORS: dict[str, dict[str, Any]] = {
    ...
    # ── GCMP 全厂商适配（来源：GCMP src/providers/config/*.json）──
    # 以下厂商都有 Coding Plan（Anthropic 兼容层），探针透传 + 本地核账。
    # monitor：这些厂商暂无公开 monitor API，只本地核账。
    "dashscope": {
        "label": "阿里云百炼 Coding Plan",
        "url_prefix": "dashscope",
        "upstream_default": "https://coding.dashscope.aliyuncs.com/apps/anthropic",
        "monitor_url_default": "",
        "auth_header": "Authorization",
        "auth_scheme": "Bearer",
        "plans": [{"id": "dashscope-coding", "label": "通义千问 Coding Plan"}],
    },
    "baidu": {
        "label": "百度千帆 Coding Plan",
        "url_prefix": "baidu",
        "upstream_default": "https://qianfan.baidubce.com/anthropic/coding",
        "monitor_url_default": "",
        "auth_header": "Authorization",
        "auth_scheme": "Bearer",
        "plans": [{"id": "baidu-coding", "label": "千帆 Coding Plan"}],
    },
    "tencent": {
        "label": "腾讯云 Coding Plan",
        "url_prefix": "tencent",
        "upstream_default": "https://api.lkeap.cloud.tencent.com/coding/anthropic",
        "monitor_url_default": "",
        "auth_header": "Authorization",
        "auth_scheme": "Bearer",
        "plans": [{"id": "tencent-coding", "label": "腾讯云 Coding Plan"}],
    },
    "xiaomimimo": {
        "label": "小米 MiMo Coding Plan",
        "url_prefix": "xiaomimimo",
        "upstream_default": "https://token-plan-cn.xiaomimimo.com/anthropic",
        "monitor_url_default": "",
        "auth_header": "Authorization",
        "auth_scheme": "Bearer",
        "plans": [{"id": "xiaomimimo-coding", "label": "MiMo Token Plan"}],
    },
    "stepfun": {
        "label": "阶跃星辰 Coding Plan",
        "url_prefix": "stepfun",
        "upstream_default": "https://api.stepfun.com",
        "monitor_url_default": "",
        "auth_header": "Authorization",
        "auth_scheme": "Bearer",
        "plans": [{"id": "stepfun-coding", "label": "Step Coding Plan"}],
    },
    "antling": {
        "label": "蚂蚁百灵 AntLing",
        "url_prefix": "antling",
        "upstream_default": "https://api.ant-ling.com/anthropic",
        "monitor_url_default": "",
        "auth_header": "Authorization",
        "auth_scheme": "Bearer",
        "plans": [{"id": "antling-coding", "label": "AntLing Coding Plan"}],
    },
    "xfyun": {
        "label": "讯飞星辰 Coding Plan",
        "url_prefix": "xfyun",
        "upstream_default": "https://maas-coding-api.cn-huabei-1.xf-yun.com/v2",
        "monitor_url_default": "",
        "auth_header": "Authorization",
        "auth_scheme": "Bearer",
        "plans": [{"id": "xfyun-coding", "label": "星辰 Coding Plan"}],
    },
    "longcat": {
        "label": "美团 LongCat Coding Plan",
        "url_prefix": "longcat",
        "upstream_default": "https://api.longcat.chat/anthropic",
        "monitor_url_default": "",
        "auth_header": "Authorization",
        "auth_scheme": "Bearer",
        "plans": [{"id": "longcat-coding", "label": "LongCat Coding Plan"}],
    },
    "streamlake": {
        "label": "快手 StreamLake Coding Plan",
        "url_prefix": "streamlake",
        "upstream_default": "https://wanqing.streamlakeapi.com/api/gateway/coding",
        "monitor_url_default": "",
        "auth_header": "Authorization",
        "auth_scheme": "Bearer",
        "plans": [{"id": "streamlake-coding", "label": "StreamLake Coding Plan"}],
    },
    "relay": {
        "label": "中转站 (自定义)",
        "url_prefix": "relay",

...
- v2 状态（2026-08-28 用户确认）：**v2 仍可续费**，6 个 v2 yml 维持 active；
  新购是否关闭未核实（官方"老用户权益说明"暗示 v2 已转为存量专属）。
- GLM-5.3-Flash 为 8-14 与 5.3 同批新增模型：Coding Plan 全档可用、积分消耗为标准的 50%
  （z.ai 侧 API 单价五折促销至 2026-09-09）；账本 5.3 主口径不变，Flash 作为低成本支线待探针实测。
